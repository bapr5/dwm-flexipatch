...
static const char *mutecmd[] = { "amixer", "-q", "set", "Master", "toggle","-c","1", NULL };
static const char *volupcmd[] = { "amixer", "-q", "set", "Master", "5%+","-c","1", "unmute", NULL };
static const char *voldowncmd[] = { "amixer", "-q", "set", "Master", "5%-","-c","1", "unmute", NULL };
static const char *miccmd[] = { "amixer", "set", "Capture", "toggle","-c","1", NULL };
static const char *screenkey[] = {"bash","/home/pr5/scripts/scrnsht.sh",NULL};
...
static const Key keys[] = {
	...
	{ 0, XK_Print, spawn, {.v=screenkey}},
	{ MODKEY,			XK_F2,	       spawn, 		       {.v = firefox } },
	{ MODKEY,			XK_F3,	       spawn,		       {.v = ranger}},
